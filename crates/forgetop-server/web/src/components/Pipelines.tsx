...
function PipeCard({ row, index }: { row: PipeRow; index: number }) {
  ...
  // A pending gate → a red "Approval needed" badge on the row (like the PR Mergeable badge);
  // the actual approve/retry/cancel actions live in the pane, not on the row.
