...
pub struct Theme {
    ...
    pub bg: Color,
    pub panel: Color,
    /// Background of a split pane that doesn't have focus — a step away from `bg`, so the
    /// pane taking the keys reads as the lit one.
    pub idle_bg: Color,
    pub fg: Color,
    pub dim: Color,
    pub sel_bg: Color,
